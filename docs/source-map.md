...
| `INT-003` | `chapters/00-introduction.md` | `ACTIVE` | Phần giới thiệu đã duyệt và cách định vị cuốn sách | Chứng minh các khẳng định kỹ thuật ngoài nguồn được trích dẫn trong phần | Giới thiệu; đầu vào cho Ch. 1–3 | SHA-256 `43ab28a907fe63138019ce88d228aa8e835757d715550b0e636bef1a253bc886` |
